...
if CC_PACKET_VERSION == 1 then
    GameAssetsManager.urlName = "https://wap.juyun66.com/Uploads/Download/Assets/lnmj/clientUpdate/"     --内网更新地址
elseif CC_PACKET_VERSION == 2 then
    GameAssetsManager.urlName = "https://wap.juyun66.com/Uploads/Download/Assets/lnmj/clientUpdateIos/"     --外网审核包更新地址
elseif CC_PACKET_VERSION == 3 then
    GameAssetsManager.urlName = "https://wap.juyun66.com/Uploads/Download/Assets/lnmj/clientUpdateBeta/" --外网发布包更新地址
end
